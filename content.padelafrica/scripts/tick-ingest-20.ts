...
const QUEUE = [
  { recordId: "MAR-VEN-028", file: "morocco-padel-verified.json", country: "Morocco" },
  { recordId: "MAR-VEN-029", file: "morocco-padel-verified.json", country: "Morocco" },
  { recordId: "ALG-VEN-001", file: "algeria-padel-verified.json", country: "Algeria" },
  { recordId: "ALG-VEN-002", file: "algeria-padel-verified.json", country: "Algeria" },
  { recordId: "ALG-VEN-003", file: "algeria-padel-verified.json", country: "Algeria" },
  { recordId: "ALG-VEN-004", file: "algeria-padel-verified.json", country: "Algeria" },
  { recordId: "ALG-VEN-005", file: "algeria-padel-verified.json", country: "Algeria" },
  { recordId: "LBY-VEN-001", file: "libya-padel-verified.json", country: "Libya" },
  { recordId: "LBY-VEN-002", file: "libya-padel-verified.json", country: "Libya" },
  { recordId: "LBY-VEN-003", file: "libya-padel-verified.json", country: "Libya" },
  { recordId: "UGA-VEN-001", file: "uganda-padel-verified.json", country: "Uganda" },
  { recordId: "UGA-VEN-002", file: "uganda-padel-verified.json", country: "Uganda" },
] as const;
...
async function main() {
  ...
  const outPath = resolve(DATA, "tick-ingest-2026-09-26T20.json");
