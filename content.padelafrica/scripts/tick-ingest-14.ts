...
const QUEUE = [
  { recordId: "ZAF-VEN-032", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "ZAF-VEN-033", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "ZAF-VEN-034", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "ZAF-VEN-035", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "ZAF-VEN-036", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "MAR-VEN-022", file: "morocco-padel-verified.json", country: "Morocco" },
  { recordId: "AGO-VEN-004", file: "angola-padel-verified.json", country: "Angola" },
  { recordId: "ZAF-VEN-037", file: "south-africa-padel-verified.json", country: "South Africa" },
] as const;
...
async function main() {
  ...
  const outPath = resolve(DATA, "tick-ingest-2026-09-26T14.json");
