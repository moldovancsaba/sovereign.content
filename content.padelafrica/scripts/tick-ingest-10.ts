...
const QUEUE = [
  { recordId: "ZAF-VEN-022", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "ZAF-VEN-023", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "ZAF-VEN-024", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "EGY-VEN-003", file: "egypt-padel-verified.json", country: "Egypt" },
  { recordId: "CPV-VEN-005", file: "cabo-verde-padel-verified.json", country: "Cabo Verde" },
] as const;
...
async function main() {
  ...
  const outPath = resolve(DATA, "tick-ingest-2026-09-26T10.json");
