...
const QUEUE = [
  { recordId: "ZAF-VEN-052", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "ZAF-VEN-053", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "ZAF-VEN-054", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "ZAF-VEN-055", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "ZAF-VEN-056", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "ZAF-VEN-057", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "ZAF-VEN-058", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "ZAF-VEN-059", file: "south-africa-padel-verified.json", country: "South Africa" },
] as const;
...
async function main() {
  ...
  const outPath = resolve(DATA, "tick-ingest-2026-09-26T17.json");
