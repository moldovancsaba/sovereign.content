...
const QUEUE = [
  { recordId: "KEN-VEN-017", file: "kenya-padel-verified.json", country: "Kenya" },
  { recordId: "KEN-VEN-018", file: "kenya-padel-verified.json", country: "Kenya" },
  { recordId: "KEN-VEN-019", file: "kenya-padel-verified.json", country: "Kenya" },
  { recordId: "KEN-VEN-020", file: "kenya-padel-verified.json", country: "Kenya" },
  { recordId: "TUN-VEN-018", file: "tunisia-padel-verified.json", country: "Tunisia" },
] as const;
...
async function main() {
  ...
  const outPath = resolve(DATA, "tick-ingest-2026-09-26T18.json");
