...
const QUEUE = [
  { recordId: "ZAF-VEN-045", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "ZAF-VEN-046", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "ZAF-VEN-047", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "ZAF-VEN-048", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "ZAF-VEN-049", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "ZAF-VEN-050", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "RWA-VEN-003", file: "rwanda-padel-verified.json", country: "Rwanda" },
  { recordId: "ZAF-VEN-051", file: "south-africa-padel-verified.json", country: "South Africa" },
] as const;
...
async function main() {
  ...
  const outPath = resolve(DATA, "tick-ingest-2026-09-26T16.json");
