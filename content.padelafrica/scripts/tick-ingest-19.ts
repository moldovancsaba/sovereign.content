...
const QUEUE = [
  // New densify
  { recordId: "MAR-VEN-023", file: "morocco-padel-verified.json", country: "Morocco" },
  { recordId: "MAR-VEN-024", file: "morocco-padel-verified.json", country: "Morocco" },
  { recordId: "MAR-VEN-025", file: "morocco-padel-verified.json", country: "Morocco" },
  { recordId: "MAR-VEN-026", file: "morocco-padel-verified.json", country: "Morocco" },
  { recordId: "MAR-VEN-027", file: "morocco-padel-verified.json", country: "Morocco" },
  { recordId: "EGY-VEN-017", file: "egypt-padel-verified.json", country: "Egypt" },
  // Prior fixtures never applied via ingest
  { recordId: "MAR-VEN-001", file: "morocco-padel-verified.json", country: "Morocco" },
  { recordId: "MAR-VEN-004", file: "morocco-padel-verified.json", country: "Morocco" },
  { recordId: "GHA-VEN-002", file: "ghana-padel-verified.json", country: "Ghana" },
  { recordId: "NAM-VEN-001", file: "namibia-padel-verified.json", country: "Namibia" },
  { recordId: "TZA-VEN-001", file: "tanzania-padel-verified.json", country: "Tanzania" },
] as const;
...
async function main() {
  ...
  const outPath = resolve(DATA, "tick-ingest-2026-09-26T19.json");
