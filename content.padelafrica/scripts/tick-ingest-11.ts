...
const QUEUE = [
  { recordId: "KEN-VEN-013", file: "kenya-padel-verified.json", country: "Kenya" },
  { recordId: "KEN-VEN-014", file: "kenya-padel-verified.json", country: "Kenya" },
  { recordId: "KEN-VEN-015", file: "kenya-padel-verified.json", country: "Kenya" },
  { recordId: "KEN-VEN-016", file: "kenya-padel-verified.json", country: "Kenya" },
  { recordId: "AGO-VEN-013", file: "angola-padel-verified.json", country: "Angola" },
  { recordId: "AGO-VEN-005", file: "angola-padel-verified.json", country: "Angola" },
] as const;
...
async function main() {
  ...
  const outPath = resolve(DATA, "tick-ingest-2026-09-26T11.json");
