...
const QUEUE = [
  { recordId: "TZA-VEN-009", file: "tanzania-padel-verified.json", country: "Tanzania" },
  { recordId: "SYC-VEN-005", file: "seychelles-padel-verified.json", country: "Seychelles" },
  { recordId: "COD-VEN-004", file: "democratic-republic-of-the-congo-padel-verified.json", country: "Democratic Republic of the Congo" },
  { recordId: "CMR-VEN-005", file: "cameroon-padel-verified.json", country: "Cameroon" },
  { recordId: "TGO-VEN-002", file: "togo-padel-verified.json", country: "Togo" },
] as const;
...
async function main() {
  ...
  const outPath = resolve(DATA, "tick-ingest-2026-09-26T09.json");
