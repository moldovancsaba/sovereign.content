...
const QUEUE = [
  { recordId: "ZAF-VEN-025", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "ZAF-VEN-026", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "ZAF-VEN-027", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "ZAF-VEN-028", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "AGO-VEN-015", file: "angola-padel-verified.json", country: "Angola" },
  { recordId: "AGO-VEN-010", file: "angola-padel-verified.json", country: "Angola" },
] as const;
...
async function main() {
  ...
  const outPath = resolve(DATA, "tick-ingest-2026-09-26T12.json");
