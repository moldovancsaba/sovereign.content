...
const QUEUE = [
  { recordId: "ZAF-VEN-038", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "ZAF-VEN-039", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "ZAF-VEN-040", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "ZAF-VEN-041", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "ZAF-VEN-042", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "ZAF-VEN-043", file: "south-africa-padel-verified.json", country: "South Africa" },
  { recordId: "ZAF-VEN-044", file: "south-africa-padel-verified.json", country: "South Africa" },
] as const;
...
async function main() {
  ...
  const outPath = resolve(DATA, "tick-ingest-2026-09-26T15.json");
