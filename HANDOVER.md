...
- [ ] **`fleet:daily-swot` Phases 3–4** — Phase 1–2 shipped (digest + `npm run fleet:daily-swot` + timer `fleet-daily-swot` @ 06:00 UTC); still open: inbox snapshots from client chats, `/fleet` index, recurring→HiTL contracts ([`fleet/digests/2026-09-24.md`](./fleet/digests/2026-09-24.md))
...
1. **`fleet:daily-swot` Phase 3+** — client `fleet/inbox` snapshots; grow digests under timer `fleet-daily-swot` (06:00 UTC); optional `/fleet` index ([`fleet/digests/2026-09-24.md`](./fleet/digests/2026-09-24.md)).
